...
var cnItems = {
    ...
    "Accessory": "配饰",
    "Achievements": "成就",
    "Ack! Something touches you from the darkness. You can't see anything in this darkness, it'll be better if you find a lightsource": "啊！ 有什么东西从黑暗中碰到了你。 在这黑暗中你什么都看不见，如果你能找到光源会更好",
    "Acorn": "橡子",
    ...
    "Allows deconstruction of items and equipment when kept in inventory": "允许在库存中分解物品和装备",
    ...
    "Alright, enough. Your sentiment is appreciated, but let us hope Dein still draws breath out there. This entire precident calls for investigation, a team of hunters will be dispatched shortly and you keep yourself alert too. And I will be taking that from your hands, thank you for bringing it here. Time will tell wether this sword becomes a memento or returns to its rightful owner": "好吧，够了。 感谢您的哀悼，但让我们希望邓恩仍然活着。 整件事都需要调查，很快就会派出一队猎人，你也要保持警惕。 我会从你手中接过它，谢谢你把它带到这里。 时间会证明这把剑是成为纪念品还是归还其合法主人",
    "Alright...": "好吧...",
    "Amber": "琥珀色",
    ...
    "Clear blob of slime. Used in elementary alchemy to make adhesives. Also acts as a base for some potions": "一团透明粘液。在初级炼金术中用于制造粘合剂。也可作为某些药水的基础",
    "Clearbane": "清毒",
    ...
    "Dangerous monsters have invaded the southern forest and terrorizing the villagers. Get rid of them!": "危险的怪物入侵了南部的森林并威胁村庄。赶走他们！",
    "Day of birth": "出生日期",
    "Days": "天",
    "Dead Bird": "死鸟",
    "Dead Mouse": "死老鼠",
    ...
    "Depletes health each second": "每秒损失生命值",
    ...
    "Dolls that could be remotely controlled by one's soul. Employed by spies to infiltrate enemy lines unnoticed": "可以被灵魂遥控的人偶。被间谍用于潜入敌军",
    ...
    "Express your condolences to the deceased": "向死者表示哀悼",
    ...
    "Fluffy ball of yarn which is normally used as a material for knitting. Cats love these and often claim them as toys": "蓬松的纱线球，通常用作针织材料。猫咪喜欢的玩具",
    ...
    "Gate Guard: \"You were given permission to proceed. Go on": "门卫：“你被允许通过了。 走吧",
    "Gauntlet": "护手",
    "General Store": "综合商店",
    "General Store ": "综合商店 ",
    "Get stronger!": "变强！",
    ...
    "Here, take this for your trouble": "来，麻烦你了",
    "Hermit": "隐士",
    ...
    "Hungry Child": "饥饿的孩子",
    "Hunt down all the wolves you find and return once you destroy at least 35 of them. You will also want this, every hunter should keep his personal notes close. And prepare medicinal bandages, just in case. Be careful, and good luck": "猎杀你能找到的所有狼，并在你消灭至少 35 只狼后返回。 另外你也会想要这个，每个猎人都应该保留他的个人笔记。 还有准备好药用绷带，以防万一。 小心点，祝你好运",
    ...
    "Initiate": "始动",
    "Instructor: Back already?": "教官：回来了吗？",
    ...
    "Instructor: This is a good start, congratulations! Keep working hard!": "教官：这是一个好的开始，恭喜！继续努力！",
    ...
    "Light umbrella with a cloud pattern. Young masters and ladies carry these to display their carefree nature": "带有云纹的轻伞。年轻的先生女士们会带着来展示洒脱的本性",
    "Likes": "喜欢",
    "Linen Vest": "亚麻背心",
    "Literacy": "识字",
    ...
    "Pinecone": "松果",
    "Plain Bed": "普通床",
    "Plain round bun, very soft and filling": "普通的圆面包，非常柔软和有馅",
    "Play Again": "再次游戏",
    "Please check the Discord to see if there are new content updates!": "请检查 Discord 以查看是否有新的内容更新！",
    "Poison Resistance": "毒抗",
    "Poison Ward": "抗毒剂",
    "Polearm M lvl: ": "长柄武器等级：",
    "Polearm Mastery": "长柄武器精通",
    "Polearm/Spear attacks": "长柄武器/长矛攻击",
    ...
    "Raises stats during night": "提高夜晚的属性数据",
    ...
    "Show Xiao Xiao a wooden doll": "给小小看木偶娃娃",
    ...
    "Sorry you can't afford that!": "对不起，你的钱不够！",
    "Soul Puppet": "魂傀",
    ...
    "Southern Forest, The Foliage": "南方森林，林中",
    ...
    "Takemitsu": "竹光剑",
    "Targe": "圆盾",
    "Tasteless soup made by boiling heaps of cure grass in water. Healing only in name, it is known that exposing cure grass to high temperatures destroys any healing properties of the product": "将成堆的治疗草在水中煮沸制成的无味汤。只是名义上的愈合，众所周知，将治疗草暴露在高温下会破坏它的任何愈合特性",
    "Tasty!": "可口！",
    ...
    "The sword! Where did you get it!?": "那把剑！ 你在哪里得到它！？",
    ...
    "Then one day he staight up vanished, without letting anyone know, and he was well respected and cared for our people all the same. Of course, being a part of the military would prevent him from disclosing his plans and duties, but it is highly doubtful a special task from the higher command would be the reason of his abscence. All of his belongins, personal items and possessions are still there, where he left them. Lad knew how to fight and wield a sword, I do not for once believe a man of his caliber would perish and die like this, the corpse you speak of might not be his...": "然后有一天他突然消失了，没有让任何人知道，他是那样受到尊重和关心我们的人民。 当然，作为军队的一员会阻止他透露他的计划和职责，但我们高度怀疑是上级指挥部的一项特殊任务造成了他的死亡。 他所有的财物、个人物品和财产都还在那里，他把它们留在了那里。 那小伙子会打仗，会挥剑，我一时不相信像他这样的人会这么死，你说的那具尸体，未必是他的……",
    ...
    "Times dodged the attack": "闪避次数",
    "Times killed with a single hit": "被一击杀死的次数",
    "Times missed the attack": "未命中次数",
    ...
    "What's this? Your aura has changed since we last met! All the martial training you went through certainly hasn't gone to waste, this kid is definitely isn't a pushover anymore, hah! If you have the guts to take on the next task, listen well - southern forest is becoming more and more dangerous, lethal beasts keep crawling in from the farther plains, making it very difficult to do any sort of work in the south. Looks like wolves this time. Some fear, at this rate, they might reach and assault the village, and that will have need to be dealth with. This is a dangerous issue, and you will have to have courage to take it on, but in turn it will serve you as great real battle experience. Other lads have already signed up, as well. Are you willing?": "什么？ 自从我们上次见面以来，你的气场发生了变化！ 你小子历练的武功没有白费，你已经不再是菜鸟了，呵！ 如果你有胆量去接下一个任务，那就听好了——南方森林变得越来越危险，危险的野兽不断从更远的平原进入，让南森的任何工作都变得非常困难。 这次看起来像是狼群。 有些人担心，以这种规模，他们可能会到达并袭击村庄，这需要有人去处理。 这是一个危险的难题，你必须有勇气接受它，而反过来它将为你提供真正的战斗体验。 其他青年也已经报名了。 你是否愿意？",
    "Wheat": "小麦",
    ...
    "You bandage your wounds": "你包扎了伤口",
    ...
    "You may want to wake up first": "你可能想先醒来",
    "You never knew this secluded area was here": "你第一次发现这个僻静的地方",
    "You notice head hunter maintaining his hunting gear": "你注意到猎人首领在维护他的狩猎装备",
    ...
    "You practiced knot tying for a short while and made": "你练习了一小会儿打结，并打了个",
    ...
    "You sight the hunter thinking deeply about something": "你看到猎人在沉思",
    ...
    "You! Why do you have that?": "嘿！ 你为什么有这个？",
    ...
    "lvl:4 'Aspiring Ronin": "lvl:4 '有抱负的浪人",
    ...
    "no": "否",
    "nobody's here": "这里没有人",
    "of hunger took a toll on your body, yet made you learn to conserve your energy by other means, which shows. Just a bit": "饥饿对你的身体造成伤害，但让你学会通过其他方式保存你的能量。 只是一点点",
    "output": "产出",
    "owned": "拥有",
    "perishable": "易腐烂的",
    "permanently": "，不可逆",
    ...
    "|Western Woods, Hunter's Lodge|": "|西部森林，猎人小屋|",
    "|Your Home, Basement|": "|你的家，地下室|",
    "|Your Home, Bed|": "|你的家, 床|",
    "|Your Home, Fireplace|": "|你的家, 壁炉|",
    "|Your Home, Storage Box|": "|你的家, 储物箱|",
    "|Your Home|": "|家|",
    "∥LOCKED∥": "∥未解锁∥",
    ...
    "Investigating": "调查",
    "You're exploring your surroundings": "你正在探索周围",
    "You're feeling tipsy": "你觉得醉了",
    "Inebriated": "醉醺醺的",
    "You're feeling drunk from alcohol": "你因酒精感到醉意",
    "You sober up": "你清醒了",
    "You discover a pouch half-etched into the ground and covered by a rock. It probably belonged to the corpse": "您发现一个埋在石头后的烂袋子。 它可能属于那具尸体",
    "Moonbloom": "月之花",
    "A yellow flower which is said to bud on new moons. The flower' nectar is the favourite of spirits and is effective for recovering from exhaustion, but only by refining it into a pill or elixir is it possible to draw out its full potential, which makes it prized by alchemists": "一朵黄色的花，据说在新月发芽。 花蜜是神灵的宠儿，有解乏之效，但只有将其炼成丹药或丹药，才能发挥其全部潜能，为炼金术士所珍视。",
    "Increases SAT by +2 permanently": "能量永久增加+2",
    "SAT increased by +2 permanently": "能量永久增加+2",
    "Candlelight": "烛光",
    "You're carrying a candle. The surroundings are lit up": "你拿着蜡烛。 照亮了四周",
    "Spiderweb lands on your face as you enter": "当你进入时，蜘蛛网落在你的脸上",
    "Examine your surroundings": "检查你的四周",
    "You glance around and find mountains of broken crates, shelves, boxes, furniture and other decaying goods. Don't expect to find anything of great value amongst this trash. Perhaps you can salvage at least something if you look careful enough": "你环顾四周，发现堆积如山的破碎板条箱、架子、盒子、家具和其他腐烂的物品。 不要指望在这些垃圾中找到任何有价值的东西。 如果你足够仔细，也许你至少可以挽救一些东西",
    "You step on some glass shards and crush them": "你踩到一些玻璃碎片并将它们压碎",
    "Various broken garbage is littered around": "周围散落着各种破碎的垃圾",
    "Ack! There's dust and cobweb everywhere in this place": "啊！ 这个地方到处都是灰尘和蜘蛛网",
    "Enable Repeatable Crafting": "开启重复制作",
    "Current speed": "当前速度",
    "Show Xiao Xiao a soul doll": "给小小看灵魂娃娃",
    "Waai thank you! I love it! I'll give you this! Here, take!": "哇，谢谢！ 我喜欢它！ 我给你这个！",
    "The girl happily runs away with her new toy": "那个女孩带着她的新玩具高兴地跑了",
    "Claim your hardearned reward": "得到你来之不易的回报",
    "You feel more peaceful": "你感到更平静",
    "You may prick your finger if you mishandle it": "一不小心就可能会刺破手指",
    "You notice a coin on the ground!": "你注意到了地上的一枚硬币！",
    "*Crunch..*": "*嘎吱..*",
    "*Pop..*": "*啵..*",
    "*Crack..*": "*咔嚓..*",
    "You have discovered some pine nuts inside!": "你在里面发现了一些松子！",
    "The cone was empty..": "这个松果是空心的...",
    "You threw Pebble into the distance": "你把卵石扔到远处",
    "Instructor: You're almost ready to face real dangers of the outside world! Keep working hard!": "教官：你已经准备好面对外面世界真正的危险了！ 继续努力！",
    "You feel closer to the Sun..": "你觉得距离太阳更近了..",
    "You feel closer to the Moon..": "你觉得距离月亮更近了..",
    "Moon blessing": "月亮祝福",
    "Moon Charm": "月亮之力",
    "Sun Charm": "太阳之力",
    "Sun blessing": "太阳祝福",
    "You are blessed by Sun": "你被太阳祝福",
    "You are blessed by Moon": "你被月亮祝福",
    "You're too occupied with something else": "你正忙于别的事情",
    "*Munch*": "*嚼*",
    "": "",
    "": "",
    "": "",
    "": "",
    "Adjustable bend":"Adjustable bend",
    "Adjustable grip hitch":"Adjustable grip hitch",
    "Albright special":"Albright special",
    "Alpine Butterfly":"Alpine Butterfly",
    "Anchor bend":"Anchor bend",
    "Angle\'s loop ":"Angle\'s loop ",
    "Arbor knot":"Arbor knot",
    "Artillery loop":"Artillery loop",
    "Ashley\'s bend":"Ashley\'s bend",
    "Axle hitch":"Axle hitch",
    "Bachmann knot":"Bachmann knot",
    "Bag knot":"Bag knot",
    "Bait loop":"Bait loop",
    "Barrel knot":"Barrel knot",
    "Basket weave knot":"Basket weave knot",
    "Becket hitch ":"Becket hitch ",
    "Beer knot":"Beer knot",
    "Bimini twist":"Bimini twist",
    "Blackwall hitch":"Blackwall hitch",
    "Blake\'s hitch":"Blake\'s hitch",
    "Blood knot":"Blood knot",
    "Boa knot":"Boa knot",
    "Boling knot":"Boling knot",
    "Boom hitch":"Boom hitch",
    "Bourchier knot":"Bourchier knot",
    "Heraldic knot":"Heraldic knot",
    "Bumper knot":"Bumper knot",
    "Bunny ears":"Bunny ears",
    "Butterfly loop":"Butterfly loop",
    "Carrick bend":"Carrick bend",
    "Cat\'s paw":"Cat\'s paw",
    "Catshank":"Catshank",
    "Celtic button knot":"Celtic button knot",
    "Chain sinnet":"Chain sinnet",
    "Chair knot":"Chair knot",
    ...
    "Death knot":"Death knot",
    "Eye splice":"Eye splice",
    "Falconer\'s knot":"Falconer\'s knot",
    "Farmer\'s loop":"Farmer\'s loop",
    "Fiador knot":"Fiador knot",
    "Figure-eight knot":"Figure-eight knot",
    "Fisherman\'s bend":"Fisherman\'s bend",
    "Friendship knot":"Friendship knot",
    "Hackamore":"Hackamore",
    "Garda hitch":"Garda hitch",
    "Grief knot":"Grief knot",
    "Gordian knot":"Gordian knot",
    "Grantchester knot":"Grantchester knot",
    "Ground-line hitch":"Ground-line hitch",
    "Gripping sailor\'s hitch":"Gripping sailor\'s hitch",
    "Halter hitch":"Halter hitch",
    "Handcuff knot":"Handcuff knot",
    "Hangman\'s noose":"Hangman\'s noose",
    "Highpoint hitch":"Highpoint hitch",
    "Highwayman\'s hitch":"Highwayman\'s hitch",
    "Hitching tie":"Hitching tie",
    "Hunter\'s bend":"Hunter\'s bend",
    "Icicle hitch":"Icicle hitch",
    "Jamming knot":"Jamming knot",
    "Killick hitch":"Killick hitch",
    "Klemheist knot":"Klemheist knot",
    "Knot of isis":"Knot of isis",
    "Lariat loop":"Lariat loop",
    "Lighterman\'s hitch":"Lighterman\'s hitch",
    "Lineman\s loop":"Lineman\s loop",
    "Lissajous knot":"Lissajous knot",
    "Lobster buoy hitch":"Lobster buoy hitch",
    "Magnus hitch":"Magnus hitch",
    "Marlinespike hitch":"Marlinespike hitch",
    "Midshipman\'s hitch":"Midshipman\'s hitch",
    "Miller\'s knot":"Miller\'s knot",
    "Monkey\'s fist":"Monkey\'s fist",
    "Mountaineer\'s coil":"Mountaineer\'s coil",
    "Munter hitch":"Munter hitch",
    "Nail knot":"Nail knot",
    "Ossel hitch":"Ossel hitch",
    "Overhand bend":"Overhand bend",
    "Palomar knot":"Palomar knot",
    "Pile hitch":"Pile hitch",
    "Pipe hitch":"Pipe hitch",
    "Pretzel link knot":"Pretzel link knot",
    "Power cinch":"Power cinch",
    ...
    "Sailor\'s hitch":"Sailor\'s hitch",
    "Sheepshank":"Sheepshank",
    "Shoelace knot":"Shoelace knot",
    "Simple knot":"Simple knot",
    "Slip knot":"Slip knot",
    "Snell knot":"Snell knot",
    "Snuggle hitch":"Snuggle hitch",
    "Span loop":"Span loop",
    ...
    "Transom knot":"Transom knot",
    "Thumb knot":"Thumb knot",
    "Threefoil knot":"Threefoil knot",
    "Trident loop":"Trident loop",
    "Trilene knot":"Trilene knot",
    "Triple crown knot":"Triple crown knot",
    "True lover\'s knot":"True lover\'s knot",
    "Turle knot":"Turle knot",
    "Versatackle knot":"Versatackle knot",
    "Underhand knot":"Underhand knot",
    "Underwriter\'s knot":"Underwriter\'s knot",
    "Uni knot":"Uni knot",
    "Wall and crown knot":"Wall and crown knot",
    "Water knot":"Water knot",
    "Windsor knot":"Windsor knot",
    "Yosemite bowlin":"Yosemite bowlin",
...
var cnPrefix = {
    ...
    "Instructor: For all your stuff I can fetch you": "教官：你所有的东西给我，我可以给你 ",
